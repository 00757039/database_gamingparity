<?php
    ...
    *, *::before, *::after { box-sizing: inherit; }
    ...
    <body background="https://i.ibb.co/CsMxYy0/tDQMOc.jpg">
        ...
        <br></br>
        <div  id="shadowbox">
            <form action="search_made.php" method="post">
            搜尋：<input type="text" name="made" class="light-table-filter" data-table="order-table" placeholder="請輸入關鍵字">
            </form>
